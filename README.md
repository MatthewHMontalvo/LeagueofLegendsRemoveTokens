...
| Before | After |
|:---:|:---:|
| ![Profile with tokens equipped](/LeagueTokenScreenshots/profile_before.png) | ![Profile with tokens cleared](/screenshots/LeagueTokenScreenshots/profile_after.png) |
